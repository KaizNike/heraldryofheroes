...
func _ready():
	...
	$TextBox/Intro.text = (pc_data.dict["first_name"] + " then thinks about "
		+ pc_data.dict["her_his"] + " mother, who...")
	
	if party_dict["prev_outcome"] == "rural":
		$TextBox/Options/Mother1.text = "...was a farmer growing crops and raising livestock."
		upgrades1 = ["polearm","impact","woodwise","riding"]
		outcome_text1 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
		$TextBox/Options/Mother2.text = "...forraged and made medicine from herbs."
		upgrades2 = ["alchemy","impact","woodwise","woodwise","riding"]
		outcome_text2 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
		$TextBox/Options/Mother3.text = "...repaired tools for the farmers."
		upgrades3 = ["polearm","polearm","polearm","impact","woodwise","woodwise","riding","riding"]
		outcome_text3 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
		$TextBox/Options/Mother4.text = "...devoted her life to the church."
		upgrades4 = ["religion","religion","religion","righteous","righteous","righteous","read_write"]
		outcome_text4 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
	elif party_dict["prev_outcome"] == "urban":
		$TextBox/Options/Mother1.text = "...worked at a market stall selling vegetables."
		upgrades1 = ["streetwise","streetwise","streetwise","speak","speak","speak","trade"]
		outcome_text1 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
		$TextBox/Options/Mother2.text = "...brewed beer, wine and other concoctions at the tavern."
		upgrades2 = ["alchemy","streetwise","speak","trade","heal","artifice"]
		outcome_text2 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
		$TextBox/Options/Mother3.text = "...repaired wagons for traveling merchants."
		upgrades3 = ["impact","artifice","artifice","artifice","trade","speak"]
		outcome_text3 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
		$TextBox/Options/Mother4.text = "...worked at the docks."
		upgrades4 = ["strength","speak","trade","streetwise","streetwise"]
		outcome_text4 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
	elif party_dict["prev_outcome"] == "crafts":
		$TextBox/Options/Mother1.text = "...weaved cloth and sewed clothing."
		upgrades1 = ["artifice","artifice","artifice","speak","streetwise"]
		outcome_text1 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
		$TextBox/Options/Mother2.text = "...fabricated locks and keys."
		upgrades2 = ["artifice","artifice","artifice","artifice","alchemy","trade"]
		outcome_text2 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
		$TextBox/Options/Mother3.text = "...made saddles and other equipment for horses."
		upgrades3 = ["artifice","artifice","artifice","riding","riding","woodwise"]
		outcome_text3 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
		$TextBox/Options/Mother4.text = "...worked metal into weapons."
		upgrades4 = ["artifice","artifice","artifice","strength","endurance","trade"]
		outcome_text4 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
	elif party_dict["prev_outcome"] == "merchant":
		$TextBox/Options/Mother1.text = "...managed the money for the business."
		upgrades1 = ["trade","trade","trade","speak","read_write","read_write","read_write",
			"latin"]
		outcome_text1 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
		$TextBox/Options/Mother2.text = "...read and studied widely."
		upgrades2 = ["alchemy","alchemy","read_write","read_write","read_write","latin","latin",
			"religion","religion"]
		outcome_text2 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
		$TextBox/Options/Mother3.text = "...negotiated contracts with nobility and the church."
		upgrades3 = ["trade","trade","trade","speak","speak","speak","latin","latin","latin"]
		outcome_text3 = ( "She taught " + pc_data.dict["first_name"]
			+ " much about that way of life." )
		$TextBox/Options/Mother4.text = "...was a skilled healer and apothecary."
...
func scene_outcome():
	next_scene = "res://scenarios/aa_pc_create/pc_create_father.tscn"
