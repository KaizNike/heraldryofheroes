...
func _on_vagabond_pressed():
	...
	+ pc_data.dict["trade"] + pc_data.dict["streetwise"] + pc_data.dict["woodwise"] + pc_data.dict["riding"]
		...
		party_data["prev_outcome"] = "vagabond success"
		...
		party_data["prev_outcome"] = "vagabond failure"
...
func _on_guard_pressed():
	...
	+ pc_data.dict["gun"] + pc_data.dict["strength_max"] + pc_data.dict["endurance_max"]
		...
		party_data["prev_outcome"] = "guard success"
		...
		party_data["prev_outcome"] = "guard failure"
...
func _on_smith_pressed():
	...
	+ pc_data.dict["strength_max"] + pc_data.dict["agility_max"]
		...
		party_data["prev_outcome"] = "smith success"
		...
		party_data["prev_outcome"] = "smith failure"
...
func _on_hunter_pressed():
	...
	+ pc_data.dict["agility_max"] + pc_data.dict["perception_max"]
		...
		party_data["prev_outcome"] = "hunter success"
		...
		party_data["prev_outcome"] = "hunter failure"
...
func _on_physician_pressed():
	...
	+ pc_data.dict["intelligence_max"] + pc_data.dict["perception_max"]
		...
		party_data["prev_outcome"] = "physician success"
		...
		party_data["prev_outcome"] = "physician failure"
...
func _on_church_pressed():
	...
	+ pc_data.dict["righteous"] + pc_data.dict["perception_max"]
		...
		party_data["prev_outcome"] = "church success"
		...
		party_data["prev_outcome"] = "church failure"
		$TextBox/Outcome.text = ( pc_data.dict["first_name"] + " found "
...
func _on_student_pressed():
	...
	+ pc_data.dict["intelligence_max"] + pc_data.dict["perception_max"]
		...
		party_data["prev_outcome"] = "student success"
		...
		party_data["prev_outcome"] = "student failure"
...
func _on_merchant_pressed():
	...
	+ pc_data.dict["streetwise"] + pc_data.dict["charisma_max"]
		...
		party_data["prev_outcome"] = "merchant success"
		...
		party_data["prev_outcome"] = "merchant failure"
...
func _on_career_pressed():
	...
	+ pc_data.dict["streetwise"] + pc_data.dict["charisma_max"]
		...
		$TextBox/Outcome.text = ( pc_data.dict["first_name"] + " was overwhelmed in the bustling "
			+ "market environment and customers found " + pc_data.dict["her_him"]
			+ " unconvincing, so " + pc_data.dict["she_he"]
			+ " performed laboring duties, carting goods across the city "
			+ ", to and from the docks.")
		upgrades = ["strength_max","endurance_max","streetwise","trade","polearm","throw"]
		downgrades = ["blade","shield","gun","bow","religion","righteous"]
	scene_outcome()
...
func scene_outcome():
	...
	$TextBox/Outcome.text += party_data["prev_outcome"]
...
func set_jobs():
	...
	if party_data["prev_outcome"] == "vagabond success":
		jobs_available.append("courier")
		$TextBox/Options/Career.text = "...worked as a courier."
	elif party_data["prev_outcome"] == "vagabond failure":
		jobs_available.append("bandit")
	elif party_data["prev_outcome"] == "guard success":
		jobs_available.append("soldier")
	elif party_data["prev_outcome"] == "guard failure":
		jobs_available.append("acolyte")
	elif party_data["prev_outcome"] == "smith success":
		jobs_available.append("blacksmith")
	elif party_data["prev_outcome"] == "smith failure":
		jobs_available.append("trader")
	elif party_data["prev_outcome"] == "hunter success":
		jobs_available.append("hunt_leader")
	elif party_data["prev_outcome"] == "hunter failure":
		jobs_available.append("leather_worker")
	elif party_data["prev_outcome"] == "physician success":
		jobs_available.append("physician_assistant")
	elif party_data["prev_outcome"] == "physician failure":
		jobs_available.append("scribe")
	elif party_data["prev_outcome"] == "church success":
		jobs_available.append("priest")
	elif party_data["prev_outcome"] == "church failure":
		jobs_available.append("inventor")
	elif party_data["prev_outcome"] == "student success":
		jobs_available.append("lawyer")
	elif party_data["prev_outcome"] == "student failure":
		jobs_available.append("hunter")
	elif party_data["prev_outcome"] == "merchant success":
		jobs_available.append("manager")
	elif party_data["prev_outcome"] == "merchant failure":
		jobs_available.append("laborer")
