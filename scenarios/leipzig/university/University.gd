...
func _ready():
	...
	Data.stats["location"] = "leipzig/university/University"
	Data.save_game()
...
func _on_tutor_pressed():
	pass # Replace with function body.

func _on_alchemist_uni_pressed():
	pass # Replace with function body.
...
func fade_in_scenery():
	...
	if winter:
		if night:
			texture = load("res://scenarios/leipzig/university/University-WN.jpg")
			$FadePanel/Player.play("fade_in_dark")
		else:
			texture = load("res://scenarios/leipzig/university/University-WD.jpg")
			$FadePanel/Player.play("fade_in_light")
	else:
		if night:
			texture = load("res://scenarios/leipzig/university/University-SN.jpg")
			$FadePanel/Player.play("fade_in_dark")
		else:
			texture = load("res://scenarios/leipzig/university/University-SD.jpg")
			$FadePanel/Player.play("fade_in_light")
