...
func _ready():
	...
	Data.get_node("Party").dict["location"] = "res://scenarios/leipzig/docks/docks.tscn"
	Data.save_game()
...
func _on_side_st_pressed():
	$TextBox/Outcome.text = "You return to the side street leading back to the guilds and crafts."
...
func fade_in_scenery():
	...
	if winter:
		if night:
			texture = load("res://scenarios/leipzig/docks/docks_wn.jpg")
			$FadePanel/Player.play("fade_in_dark")
		else:
			texture = load("res://scenarios/leipzig/docks/docks_wd.jpg")
			$FadePanel/Player.play("fade_in_light")
	else:
		if night:
			texture = load("res://scenarios/leipzig/docks/docks_sn.jpg")
			$FadePanel/Player.play("fade_in_dark")
		else:
			texture = load("res://scenarios/leipzig/docks/docks_sd.jpg")
			$FadePanel/Player.play("fade_in_light")
