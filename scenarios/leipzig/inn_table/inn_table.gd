...
func create_new_pc():
	if Main.pc1.visible == false:
		party_data["pc_focus"] = "PC1"
		Data.get_node("PC1").create_pc()
	elif Main.pc2.visible == false:
		party_data["pc_focus"] = "PC2"
		Data.get_node("PC2").create_pc()
	elif Main.pc3.visible == false:
		party_data["pc_focus"] = "PC3"
		Data.get_node("PC3").create_pc()
	elif Main.pc4.visible == false:
		party_data["pc_focus"] = "PC4"
		Data.get_node("PC4").create_pc()
	elif Main.pc5.visible == false:
		party_data["pc_focus"] = "PC5"
		Data.get_node("PC5").create_pc()
	else:
		return
