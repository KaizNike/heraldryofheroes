...
func _ready():
	...
	Data.get_node("Party").dict["location"] = "res://scenarios/leipzig/market/market.tscn"
	Data.save_game()
...
func _on_general_trader_pressed():
	...
	next_scene = "res://scenarios/leipzig/general_trader/general_trader.tscn"
	scene_outcome()

func _on_bootmaker_pressed():
	$TextBox/Outcome.text = "You approach the stall of a cobbler and bootmaker."
	next_scene = "res://scenarios/leipzig/boot_maker/boot_maker.tscn"
	scene_outcome()
...
func _on_wealthy_merchant_pressed():
	...
	next_scene = "res://scenarios/leipzig/wealthy_merchant/wealthy_merchant.tscn"
	scene_outcome()
...
func fade_in_scenery():
	...
	if winter:
		if night:
			texture = load("res://scenarios/leipzig/market/market_wn.jpg")
			$FadePanel/Player.play("fade_in_dark")
		else:
			texture = load("res://scenarios/leipzig/market/market_wd.jpg")
			$FadePanel/Player.play("fade_in_light")
	else:
		if night:
			texture = load("res://scenarios/leipzig/market/market_sn.jpg")
			$FadePanel/Player.play("fade_in_dark")
		else:
			texture = load("res://scenarios/leipzig/market/market_sd.jpg")
			$FadePanel/Player.play("fade_in_light")
