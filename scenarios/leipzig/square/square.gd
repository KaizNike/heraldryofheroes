...
func _ready():
	...
	Data.get_node("Party").dict["location"] = "res://scenarios/leipzig/square/square.tscn"
	Data.save_game()
...
func _on_rathaus_pressed():
	$TextBox/Outcome.text = "You walk to the entrance of the Rathaus."
	next_scene = "res://scenarios/leipzig/rathaus/rathaus.tscn"
	scene_outcome()
	
func _on_main_st_pressed():
	$TextBox/Outcome.text = "You walk back to the main street."
	next_scene = "res://scenarios/leipzig/main_st/main_st.tscn"
	scene_outcome()

func _on_side_st_pressed():
	$TextBox/Outcome.text = "You take a side street towards the crafts and guilds district."
	next_scene = "res://scenarios/leipzig/side_st/side_st.tscn"
	scene_outcome()

func _on_latin_quarter_pressed():
	$TextBox/Outcome.text = "You head over to the Latin Quarter."
	next_scene = "res://scenarios/leipzig/latin_quarter/latin_quarter.tscn"
	scene_outcome()
...
func fade_in_scenery():
	...
	if winter:
		if night:
			texture = load("res://scenarios/leipzig/square/square_wn.jpg")
			$FadePanel/Player.play("fade_in_dark")
		else:
			texture = load("res://scenarios/leipzig/square/square_wd.jpg")
			$FadePanel/Player.play("fade_in_light")
	else:
		if night:
			texture = load("res://scenarios/leipzig/square/square_sn.jpg")
			$FadePanel/Player.play("fade_in_dark")
		else:
			texture = load("res://scenarios/leipzig/square/square_sd.jpg")
			$FadePanel/Player.play("fade_in_light")
