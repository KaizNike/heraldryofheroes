...
func _ready():
	...
	Data.stats["location"] = "leipzig/crafts/Crafts"
	Data.save_game()
...
func fade_in_scenery():
	...
	if winter:
		if night:
			texture = load("res://scenarios/leipzig/crafts/Crafts-WN.jpg")
			$FadePanel/Player.play("fade_in_dark")
		else:
			texture = load("res://scenarios/leipzig/crafts/Crafts-WD.jpg")
			$FadePanel/Player.play("fade_in_light")
	else:
		if night:
			texture = load("res://scenarios/leipzig/crafts/Crafts-SN.jpg")
			$FadePanel/Player.play("fade_in_dark")
		else:
			texture = load("res://scenarios/leipzig/crafts/Crafts-SD.jpg")
			$FadePanel/Player.play("fade_in_light")
