...
func _ready():
	...
	Data.stats["location"] = "leipzig/docks/Docks"
	Data.save_game()
...
func fade_in_scenery():
	...
	if winter:
		if night:
			texture = load("res://scenarios/leipzig/docks/Docks-WN.jpg")
			$FadePanel/Player.play("fade_in_dark")
		else:
			texture = load("res://scenarios/leipzig/docks/Docks-WD.jpg")
			$FadePanel/Player.play("fade_in_light")
	else:
		if night:
			texture = load("res://scenarios/leipzig/docks/Docks-SN.jpg")
			$FadePanel/Player.play("fade_in_dark")
		else:
			texture = load("res://scenarios/leipzig/docks/Docks-SD.jpg")
			$FadePanel/Player.play("fade_in_light")
